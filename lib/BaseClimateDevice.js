...
module.exports = class BaseClimateDevice extends Homey.Device {
  ...
  matchesDecodedAdvertisement(adv, decoded) {
    ...
    // Never match by localName or model. Multiple sensors can share names/models.
    return false;
  }
  ...
  async applyCommonCapabilities(adv, decoded) {
    ...
    if (
      this.hasCapability('measure_humidity') &&
    ...
    if (
      ...
      typeof decoded.batteryLow === 'boolean'
    ) {
